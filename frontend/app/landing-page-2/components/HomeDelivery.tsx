export default function HomeDelivery() {
    const benefits = [
        "No Delivery Platform Commissions",
        "Direct Relationship With Customers",
        "One Menu For Dine-In and Delivery",
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
                    ...
                    <div className="lg:w-1/2" data-animate>
                        ...
                        <p className="text-lg text-mutedgray leading-relaxed mb-8">
                            Restaurants can share their digital menu link with customers through WhatsApp, allowing customers to browse the menu and place orders directly from home.
                        </p>
                ...
                <div data-animate className="mt-16 text-center max-w-3xl mx-auto px-4 bg-white/50 backdrop-blur-sm rounded-2xl p-8 border border-warm-200/60 shadow-sm">
                    ...
                    <p className="text-lg sm:text-xl text-teal-700 font-medium">
                        Simply use your mobile phone to receive orders on WhatsApp and check payments in your UPI app. No laptop or special hardware is needed to run the system.
                    </p>
                </div>
            </div>
        </section>
